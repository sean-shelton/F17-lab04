package edu.ucsb.cs56.drawings.alnawakhtha;
...
/** SimpleGui1 comes from Head First Java 2nd Edition p. 355.
    ...
    @author Yusuf Alnawakhtha (changed the color and the text of the button)
...
public class SimpleGui1 {
    ...
    */
	...
	java.awt.Color myColor = new java.awt.Color(235,171,113);   // R, G, B values.
