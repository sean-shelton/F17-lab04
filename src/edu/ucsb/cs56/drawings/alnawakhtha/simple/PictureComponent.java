package edu.ucsb.cs56.drawings.alnawakhtha.simple;
...
/**
   ...
   @author Yusuf Alnawakhtha (fixed the snowmans's head)
...
{  
    ...
    {  
        ...
        Circle snowManTopCircle = 
            ...
            (
	     snowManCenterBottomX,
	     snowManCenterBottomY - bottomRadius * 2 - 2 * middleRadius - topRadius,
	     topRadius
	     );
        g2.draw(snowManTopCircle);


        g2.drawString("Yusuf Alnawakhtha's Winter Wonderland", 20,20);
