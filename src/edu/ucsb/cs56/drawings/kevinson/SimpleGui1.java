package edu.ucsb.cs56.drawings.kevinson;
...
public class SimpleGui1 {
    ...
    */
	...
	JButton button = new JButton("Click me for a surprise!") ;
	
	java.awt.Color myColor = new java.awt.Color(000,204,255);   // R, G, B values.
